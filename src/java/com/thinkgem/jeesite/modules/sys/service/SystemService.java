...
public class SystemService extends BaseService implements InitializingBean {
	...
	public List<String> findUserByRoleId(String roleId){
		List<String> list = userDao.findUserByRoleId(roleId);
		return list;
	}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean printKeyLoadMessage(){
		...
		sb.append("\r\n======================================================================\r\n");
		sb.append("\r\n    欢迎使用 "+Global.getConfig("productName")+"  - Powered By zjgmsa\r\n");
		sb.append("\r\n======================================================================\r\n");
	...
	public String getOfficeAddress(Office currentUserOffice) {
		return officeDao.getOfficeAddress(currentUserOffice);
	}

	public List<User> findUserByNames(List<String> list) {
		return userDao.findUserByNames(list);
	}

	public List<User> findCaptainByOfficeId(String officeId) {
		List<User> list = new ArrayList<User>();
		//if (list == null){
			User user = new User();
			user.setOffice(new Office(officeId));
			list = userDao.findCaptainByOfficeId(user);
			//CacheUtils.put(UserUtils.USER_CACHE, UserUtils.USER_CACHE_LIST_BY_OFFICE_ID_ + officeId, list);
		//}
		return list;
	}

	public List<User> findOfficerByOfficeId(String officeId) {
		List<User> list = new ArrayList<User>();
		//if (list == null){
			User user = new User();
			user.setOffice(new Office(officeId));
	...
	public List<User> finAllUser() {
		...
		return userDao.findAllUsers(new User());
	}
